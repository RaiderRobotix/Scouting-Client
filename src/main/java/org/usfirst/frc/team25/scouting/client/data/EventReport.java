...
public class EventReport {
    ...
    public String quickTeamReport(int teamNum) {
        ...
        formatString.append("Cross baseline: ").append(Statistics.round(report.reachBaselinePercentage, 2)).append("% (").append(report.totalReachBaseline).append("/").append(report.entries.size()).append(")").append("<br>");
    ...
    public void generatePicklists(File outputDirectory) {
        ...
        FileManager.outputFile(new File(outputDirectory.getAbsolutePath() + "\\picknum_list.txt"), pickNumListOut.toString());
