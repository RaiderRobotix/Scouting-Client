...
public class BlueAlliance {
    ...
    private static void exportTeamList(String eventCode, String fileName, TBA tba) throws FileNotFoundException {
        ...
        try {
            for (Team team : Sorters.sortByTeamNum(new ArrayList<>(Arrays.asList(tba.eventRequest.getTeams(eventCode)))))
    ...
    private static void exportMatchList(String eventCode, String fileName, TBA tba) throws FileNotFoundException {
        ...
        try {
            for (Match match : Sorters.sortByMatchNum(Sorters.filterQualification(new ArrayList<>(Arrays.asList(tba.eventRequest.getMatches(eventCode)))))) {
    ...
    public static void downloadEventMatchData(String eventCode, TBA tba, File outputDirectory) throws IOException {
        ArrayList<Match> matches = Sorters.sortByMatchNum(Sorters.filterQualification(new ArrayList<>(Arrays.asList(tba.eventRequest.getMatches(eventCode)))));
        Gson gson = new Gson();
